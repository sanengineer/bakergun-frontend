            ...
            <div className="nav-foot">
              <ul className="site-map-foot">
                <li className="site-map-item nav-item">
                  <a className="site-link" href="/#heroSection">
                    Home
                  </a>
                </li>
                <li className="site-map-item nav-item">
                  <a className="site-link" href="/#aboutUsSection">
                    About
                  </a>
                </li>
                <li className="site-map-item nav-item">
                ...
                <li className="site-map-item nav-item">
                  <a className="site-link" href="/#quotesSection">
                    Quotes
                  </a>
                </li>
                <li className="site-map-item nav-item">
                  <a className="site-link" href="/#featuresSection">
                    Feature
                  </a>
                </li>
              </ul>
            ...
            <div className="rules-net">
              <ul className="rulnet-unlst">
                <li className="rulnet-lst">
                  <Anchor className="rulnet-link" href="/privacy-policy">
                    Privacy Policy
                  </Anchor>
                </li>
                <li className="rulnet-lst">
                  <a className="rulnet-link" href="/term">
                    Terms Of Services
                  </a>
                </li>
                <li className="rulnet-lst">
                  <a className="rulnet-link" href="/code-of-conduct">
                    Code Of Conduct
                  </a>
                </li>
              </ul>
